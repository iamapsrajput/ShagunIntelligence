...
class TaskDelegator:
    ...
    def create_task(self, agent_type: Any, method: str, parameters: Dict[str, Any],
                   priority: TaskPriority = TaskPriority.MEDIUM,
    ...
    def _execute_task_internal(self, task: Task) -> Dict[str, Any]:
        ...
        try:
            ...
            if not method:
                raise AttributeError(f"Method {task.method} not found on agent {task.agent_type}")
    ...
    def _execute_with_timeout(self, method: Callable, parameters: Dict[str, Any], 
                            timeout: int) -> Any:
    ...
    def _update_agent_performance(self, agent_type: Any, success: bool, 
