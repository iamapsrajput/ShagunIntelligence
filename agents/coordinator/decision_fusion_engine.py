...
class DecisionFusionEngine:
    ...
    def fuse_insights(self, symbol: str, market_analysis: Dict[str, Any],
                     technical_analysis: Dict[str, Any],
                     sentiment_analysis: Dict[str, Any],
                     fundamental_analysis: Optional[Dict[str, Any]] = None) -> Optional[Any]:
        ...
        try:
            ...
            if fundamental_analysis:
                fundamental_signal = self._extract_fundamental_signal(fundamental_analysis)
                signals["fundamental"] = fundamental_signal
            
            # Check if we have sufficient data
            valid_signals = {k: v for k, v in signals.items() if v is not None}
            if len(valid_signals) < 2:
                logger.warning(f"Insufficient signals for {symbol}: only {len(valid_signals)} available")
                return None
    ...
    def _extract_market_signal(self, analysis: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_technical_signal(self, analysis: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_sentiment_signal(self, analysis: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _extract_fundamental_signal(self, analysis: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _calculate_weighted_consensus(self, signals: Dict[str, Dict[str, Any]]) -> float:
    ...
    def _calculate_confidence(self, signals: Dict[str, Dict[str, Any]], 
    ...
    def _estimate_expected_return(self, signals: Dict[str, Dict[str, Any]], 
                                action: str, strength: float) -> float:
    ...
    def _calculate_risk_score(self, symbol: str, signals: Dict[str, Dict[str, Any]],
    ...
    def _get_contributing_factors(self, signals: Dict[str, Dict[str, Any]]) -> Dict[str, float]:
    ...
    def _apply_risk_adjustments(self, signal: FusedSignal, 
                               market_analysis: Dict[str, Any]) -> FusedSignal:
