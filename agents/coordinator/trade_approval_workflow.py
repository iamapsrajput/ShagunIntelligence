...
class TradeApprovalWorkflow:
    ...
    def process_decision(self, decision: Dict[str, Any], 
                        risk_manager_agent: Optional[Any] = None) -> Dict[str, Any]:
    ...
    def _get_decision_context(self, decision: Dict[str, Any], 
                            risk_manager_agent: Optional[Any]) -> Dict[str, Any]:
    ...
    def _apply_approval_rules(self, decision: Dict[str, Any], 
    ...
    def _handle_conditional_approval(self, decision: Dict[str, Any],
    ...
    def _check_position_concentration(self, decision: Dict[str, Any],
    ...
    def _record_approval(self, decision: Dict[str, Any], 
        ...
        self.approval_history.append({
            ...
            "reason": approval_result.get("reason", "").value if approval_result.get("reason") else None,
