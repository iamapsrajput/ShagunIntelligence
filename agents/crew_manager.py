...
class CrewManager:
    def __init__(self):
        ...
        self.risk_manager = RiskManagerAgent(self.llm, capital=100000)  # Default 100k capital
    ...
    async def analyze_with_indicators(self, symbol: str, data: Any, timeframe: str = "5min") -> Dict[str, Any]:
    ...
    async def get_real_time_signals(self, symbols: list, timeframe: str = "5min") -> Dict[str, Any]:
    ...
    async def analyze_with_sentiment(
        ...
        try:
            ...
            return {
                ...
                "crew_analysis": str(crew_result),
                "recommended_action": self._extract_action(str(crew_result)),
                "sentiment_score": sentiment_analysis['sentiment_scores']['overall_score'],
                "sentiment_confidence": sentiment_analysis['sentiment_scores']['confidence'],
                "timestamp": asyncio.get_event_loop().time()
            }
    ...
    async def monitor_market_sentiment(
        ...
        try:
            ...
            return {
                ...
                "recommendations": self._generate_market_recommendations(market_sentiment),
                "timestamp": asyncio.get_event_loop().time()
            }
    ...
    async def generate_sentiment_report(
        ...
        try:
            ...
            review_task = Task(
                description=f"Review sentiment report and provide trading insights",
                agent=self.trader.agent,
