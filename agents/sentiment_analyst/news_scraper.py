...
class NewsScraper:
    ...
    async def scrape_market_news(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            market_keywords = ['market', 'dow', 'nasdaq', 's&p', 'economy', 'fed', 'inflation']
            market_articles = []
    ...
    async def scrape_sector_news(self, sector: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            sector_keywords = {
                'technology': ['tech', 'software', 'hardware', 'semiconductor', 'ai', 'cloud'],
                ...
                'consumer': ['retail', 'consumer', 'e-commerce', 'restaurant', 'apparel'],
                'industrial': ['manufacturing', 'industrial', 'aerospace', 'defense', 'machinery']
            }
