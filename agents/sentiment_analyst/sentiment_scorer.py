...
class SentimentScorer:
    ...
    def __init__(self, openai_api_key: Optional[str] = None):
        ...
        self.positive_keywords = {
            'strong': ['surge', 'soar', 'rally', 'breakout', 'bullish', 'upgrade', 'beat', 'exceed'],
            'moderate': ['gain', 'rise', 'increase', 'improve', 'positive', 'growth', 'expand'],
            'mild': ['steady', 'stable', 'maintain', 'support', 'optimistic']
        }
        
        self.negative_keywords = {
            'strong': ['crash', 'plunge', 'collapse', 'bearish', 'downgrade', 'miss', 'fail'],
            'moderate': ['fall', 'drop', 'decline', 'decrease', 'negative', 'loss', 'cut'],
...
Be precise and consider the financial context."""
            ...
            implication = implication_match.group(1).lower() if implication_match else 'neutral'
    ...
    def get_market_sentiment_summary(
        ...
        ] if confidences else scores
        
        overall_sentiment = sum(weighted_scores) / len(weighted_scores) if weighted_scores else 0
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'models': ['vader', 'textblob'] + (['gpt-4'] if self.openai_api_key else [])
        }