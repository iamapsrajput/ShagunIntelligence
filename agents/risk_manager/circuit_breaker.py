...
class CircuitBreaker:
    ...
    def check_conditions(
        ...
        try:
            ...
            if portfolio_value and initial_capital:
                portfolio_loss = self._check_portfolio_loss(portfolio_value, initial_capital)
    ...
    def check_portfolio_circuit(
        ...
        try:
            ...
            status = CircuitBreakerStatus.TRIGGERED if triggered else CircuitBreakerStatus.NORMAL
    ...
    def _check_market_drop(self, market_data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'severity': abs(market_return / self.thresholds['market_drop']) if triggered else 0
            }
    ...
    def _check_portfolio_loss(self, current_value: float, initial_value: float) -> Dict[str, Any]:
    ...
    def _check_drawdown(self, current_value: float, peak_value: float) -> Dict[str, Any]:
    ...
    def _time_until_reset(self) -> Optional[str]:
    ...
    def _approaching_limits(self, conditions: Dict[str, Any]) -> bool:
        ...
        for key, condition in conditions.items():
            if isinstance(condition, dict) and 'value' in condition and 'threshold' in condition:
