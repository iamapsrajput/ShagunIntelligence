...
class RiskMetricsCalculator:
    ...
    def calculate_portfolio_var(
        ...
        try:
            ...
            if method == 'historical':
                ...
                var_return = self._monte_carlo_var(portfolio_returns, confidence_level, time_horizon)
            else:
                var_return = self._historical_var(portfolio_returns, confidence_level)
    ...
    def calculate_max_drawdown(
        ...
        try:
            ...
            return {
                ...
                'peak_date': peak_idx,
                'trough_value': portfolio_values[max_drawdown_idx] if max_drawdown_idx else current_value,
                'trough_date': max_drawdown_idx,
                'recovery_date': recovery_idx,
                'recovery_time': (recovery_idx - max_drawdown_idx).days if recovery_idx else None,
                'drawdown_duration': (max_drawdown_idx - peak_idx).days if peak_idx and max_drawdown_idx else None,
                'in_drawdown': current_drawdown < -0.01,  # More than 1% drawdown
                'interpretation': self._interpret_drawdown(max_drawdown, current_drawdown)
            }
    ...
    def calculate_risk_adjusted_metrics(
        ...
        try:
            ...
            drawdown_info = self.calculate_max_drawdown(
                0, positions, market_data
            )
            ...
            return {
                ...
                'return_per_unit_risk': annual_return / annual_vol if annual_vol > 0 else 0,
