...
from .exceptions import KiteAuthenticationError, KiteWebSocketError
...
class KiteWebSocketClient:
    ...
    def __init__(self, auth_manager: KiteAuthManager):
        ...
        self.on_order_update_callback: Callable | None = None
    ...
    def get_latest_tick(self, token: int) -> dict[str, Any] | None:
