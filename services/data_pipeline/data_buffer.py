...
class DataBuffer:
    ...
    def __init__(self, max_size: int = 10000, history_minutes: int = 60):
        ...
        # Statistics
        self.stats = {"total_ticks": 0, "buffer_overflows": 0, "symbols_tracked": 0}
        ...
        logger.info(
            f"DataBuffer initialized with max_size={max_size}, "
    ...
    def get_ohlc(
        self, symbol: str, interval: str = "1min", count: int = 100
    ) -> list[dict[str, Any]]:
    ...
    def get_spread(self, symbol: str) -> dict[str, float] | None:
