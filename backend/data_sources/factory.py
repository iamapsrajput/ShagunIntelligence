...
def create_data_source_manager() -> MultiSourceDataManager:
    ...
    if settings.ALPHA_VANTAGE_ENABLED and settings.ALPHA_VANTAGE_API_KEY:
        ...
        logger.info("Alpha Vantage configuration detected but adapter not implemented yet")
    ...
    if settings.YAHOO_FINANCE_ENABLED:
        ...
        logger.info("Yahoo Finance configuration detected but adapter not implemented yet")
    ...
    if settings.TWITTER_API_ENABLED and settings.TWITTER_API_KEY:
        ...
        logger.info("Twitter API configuration detected but adapter not implemented yet")
