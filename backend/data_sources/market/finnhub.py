...
class FinnhubSource(MarketDataSource):
    ...
    async def get_quotes(self, symbols: List[str]) -> Dict[str, Dict[str, Any]]:
        ...
        batch_size = min(10, self.cost_info.requests_per_minute // 6)  # Leave room for other requests
                ...
                if response.status == 200:
                    ...
                    if "error" not in data:
                        sentiment_data = {
                            ...
                            "sector_average_sentiment": data.get("sectorAverageSentiment", 0),
                        ...
                        # Cache result
                        self.sentiment_cache[cache_key] = (datetime.utcnow(), sentiment_data)
    ...
    async def get_company_news(self, symbol: str, from_date: datetime, to_date: datetime) -> List[Dict[str, Any]]:
            ...
            if quote:
                ...
                return {
                    ...
                    "bids": [
                        ...
                        {"price": current_price * (1 - spread_percent * 2), "size": 2000},
                        {"price": current_price * (1 - spread_percent * 3), "size": 3000}
                    ],
                    "asks": [
                        {"price": current_price * (1 + spread_percent), "size": 1000},
                        {"price": current_price * (1 + spread_percent * 2), "size": 2000},
    ...
    async def get_crypto_quote(self, symbol: str, exchange: str = "BINANCE") -> Dict[str, Any]:
