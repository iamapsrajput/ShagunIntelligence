...
class MockCrewManager:
    ...
    def __init__(self):
        self.agents = {
            ...
            "technical_indicator": MockAgent("Technical Indicator", "Calculate indicators"),
            "sentiment_analyst": MockAgent("Sentiment Analyst", "Analyze market sentiment"),
    ...
    async def analyze_exit_conditions(
        ...
        # Simple exit logic
        should_exit = (
            pnl_percent > 2.0 or  # Take profit at 2%
            pnl_percent < -1.0 or  # Stop loss at -1%
            random.random() < 0.05  # 5% random exit
        )
    ...
    async def get_agent_status(self, agent_name: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_execution": agent.last_result.get("timestamp") if agent.last_result else None,
