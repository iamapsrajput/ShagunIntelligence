...
from tests.simulation.paper_trading_simulator import PaperTradingSimulator
...
class TestPaperTradingSimulation:
    ...
    async def test_portfolio_metrics(self, simulator):
        ...
        # Execute some trades
        simulator.current_prices = {"RELIANCE": 2500, "TCS": 3500, "INFY": 1500}
    ...
    async def test_drawdown_calculation(self, simulator):
        ...
        # Set initial prices
        prices = {"RELIANCE": 2500, "TCS": 3500, "INFY": 1500}
        ...
        # Peak
        await simulator.update_prices({"RELIANCE": 2600, "TCS": 3600, "INFY": 1550})

        simulator.get_portfolio_value()

        # Drawdown
        await simulator.update_prices({"RELIANCE": 2400, "TCS": 3300, "INFY": 1400})
